...
export function CalendarBridgeSettings() {
  ...
  const providers = [
    { id: "google", name: "Google Calendar", icon: "google", color: "#EA4335" },
    { id: "fastmail", name: "Fastmail Calendar", icon: "fastmail", color: "#1C6EF2" },
    { id: "caldav", name: "Any CalDAV source", icon: "caldav", color: "#666666" },
  ];
          ...
          {state.settingsCalAccounts.map((account) => (
            ...
            >
              <div className="flex items-center gap-3 flex-1">
                ...
                >
                  <Icon
                    name={account.provider === "google" ? "google" : account.provider === "fastmail" ? "fastmail" : "caldav"}
                    size={16}
                  />
                </div>
