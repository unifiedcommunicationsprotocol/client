      ...
      <div style={{ flex: 1, overflow: "auto", padding: "8px" }}>
        ...
        {MSG_CHANNELS.map((chan) => (
          <button
            key={chan.id}
            type="button"
            onClick={() => dispatch({ type: "selectChannel", payload: chan.id })}
            style={{
              width: "100%",
              textAlign: "left",
              padding: "8px 12px",
              marginBottom: "2px",
              border: "none",
              backgroundColor: state.selectedChannel === chan.id ? "var(--r-sel)" : "transparent",
              color: "var(--r-t1)",
              cursor: "pointer",
              borderRadius: "6px",
              fontSize: "13px",
        ...
        {MSG_DMS.map((dm) => (
          <button
            ...
            style={{
              ...
              marginBottom: "2px",
              border: "none",
              backgroundColor: state.selectedDM === dm.id ? "var(--r-sel)" : "transparent",
              color: "var(--r-t1)",
              cursor: "pointer",
              borderRadius: "6px",
              fontSize: "13px",
